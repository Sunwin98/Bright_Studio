...
for _mod in ("projects", "knowledge", "skin", "physics", "weapon", "checker", "merger", "settings", "filemanager", "fsbrowse", "packio", "scriptlab", "modelgen", "history", "assets", "scriptbuilder"):
